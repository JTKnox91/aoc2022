...
class AssignmentPair {
  ...
  bool get hasFullContain {
    if (firstAssignmentLeft >= secondAssignmentLeft && firstAssignmentRight <= secondAssignmentRight) {
      return true;
    }
    if (secondAssignmentLeft >= firstAssignmentLeft && secondAssignmentRight <= firstAssignmentRight) {
      return true;
    }
    return false;
  }
